...
\noindent $^\dagger$\textbf{Corresponding author}: Paul Blischak, Ohio State University, Dept. of Evolution, Ecology and Organismal Biology, 318 W. 12th Avenue, Columbus, OH 43210. E-mail: blischak.4@osu.edu.
...
\vspace{0.25in}
\includegraphics{pdfs/figure1-model-graph}
...
\vspace{0.25in}
\includegraphics{pdfs/figure2-tetra-heatmaps}
...
\vspace{0.25in}
\includegraphics{pdfs/figure3-hex-heatmaps}
