...
for(i in c("f20","f40","f60","f80")){
  for(j in c("5x","10x","15x","20x")){
    for(k in c("5ind","10ind","20ind","30ind")){
      dir<-as.character(paste("./tetra/",i,"/",j,"/",k,sep=""))
...
tetra.plot20<-heat.map20 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("5ind","10ind","20ind","30ind"), expand=c(0,0)) + scale_y_discrete(limits=c("5x","10x","15x","20x"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())
tetra.plot40<-heat.map40 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("5ind","10ind","20ind","30ind"), expand=c(0,0)) + scale_y_discrete(limits=c("5x","10x","15x","20x"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())
tetra.plot60<-heat.map60 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("5ind","10ind","20ind","30ind"), expand=c(0,0)) + scale_y_discrete(limits=c("5x","10x","15x","20x"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())
tetra.plot80<-heat.map80 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("5ind","10ind","20ind","30ind"), expand=c(0,0)) + scale_y_discrete(limits=c("5x","10x","15x","20x"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())

# Save as 3in x 2in svd files @ 300dpi

ggsave("tetra.plot20.svg",plot=tetra.plot20,width=3.25,height=2.25,units="in",dpi=300)
ggsave("tetra.plot40.svg",plot=tetra.plot40,width=3.25,height=2.25,units="in",dpi=300)
ggsave("tetra.plot60.svg",plot=tetra.plot60,width=3.25,height=2.25,units="in",dpi=300)
ggsave("tetra.plot80.svg",plot=tetra.plot80,width=3.25,height=2.25,units="in",dpi=300)
