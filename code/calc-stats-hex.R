...
hex.plot0.01<-heat.map0.01 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("i5","i10","i20","i30"), expand=c(0,0)) + scale_y_discrete(limits=c("c5","c10","c20","c50","c100"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())
hex.plot0.05<-heat.map0.05 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("i5","i10","i20","i30"), expand=c(0,0)) + scale_y_discrete(limits=c("c5","c10","c20","c50","c100"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())
hex.plot0.1<-heat.map0.1 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("i5","i10","i20","i30"), expand=c(0,0)) + scale_y_discrete(limits=c("c5","c10","c20","c50","c100"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())
hex.plot0.2<-heat.map0.2 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("i5","i10","i20","i30"), expand=c(0,0)) + scale_y_discrete(limits=c("c5","c10","c20","c50","c100"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())
hex.plot0.4<-heat.map0.4 + theme_grey(base_size = 10) + labs(x = "",y="") + scale_x_discrete(limits=c("i5","i10","i20","i30"), expand=c(0,0)) + scale_y_discrete(limits=c("c5","c10","c20","c50","c100"),expand=c(0,0)) + theme(legend.title=element_blank(), axis.ticks = element_blank())

# Save as 3in x 2in svd files @ 300dpi

ggsave("hex.plot0.01.svg",plot=hex.plot0.01,dpi=300)
ggsave("hex.plot0.05.svg",plot=hex.plot0.05,dpi=300)
ggsave("hex.plot0.1.svg",plot=hex.plot0.1,dpi=300)
ggsave("hex.plot0.2.svg",plot=hex.plot0.2,dpi=300)
ggsave("hex.plot0.4.svg",plot=hex.plot0.4,dpi=300)
